    ...
    class Program
    {
        ...
        class LinqSamples
        {
            ...
            public void Linq102()
            {
                ...
                //var result = custSupJoin.ToList();
                //var result1 = suppliers.Join(customers, a => a.Country, a => a.Country, (a, b) => new { Country = a.Country, SupplierName = a.SupplierName, CustomerName = b.CompanyName }).ToList();
            ...
            public void Linq105()
            {
                ...
                var supplierCusts =
                    from sup in suppliers
                    join cust in customers on sup.Country equals cust.Country into cs
                    from c in cs.DefaultIfEmpty()  // DefaultIfEmpty preserves left-hand elements that have no matches on the right side （左连接）
